...
/* GPIO */
#define CSR_GPIO_BASE (CSR_BASE + 0x3000L)
#define CSR_GPIO_LED_REG_ADDR (CSR_BASE + 0x3000L)
#define CSR_GPIO_LED_REG_SIZE 1
static inline uint32_t GPIO_LED_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x3000L);
}
static inline void GPIO_LED_REG_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3000L);
}
#define CSR_GPIO_SW_REG_ADDR (CSR_BASE + 0x3004L)
#define CSR_GPIO_SW_REG_SIZE 1
static inline uint32_t GPIO_SW_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x3004L);
}
#define CSR_GPIO_EV_STATUS_ADDR (CSR_BASE + 0x3008L)
#define CSR_GPIO_EV_STATUS_SIZE 1
static inline uint32_t GPIO_ev_status_read(void) {
	return csr_read_simple(CSR_BASE + 0x3008L);
}
#define CSR_GPIO_EV_STATUS_SWITCHIRQ_OFFSET 0
#define CSR_GPIO_EV_STATUS_SWITCHIRQ_SIZE 1
static inline uint32_t GPIO_ev_status_switchirq_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t GPIO_ev_status_switchirq_read(void) {
	uint32_t word = GPIO_ev_status_read();
	return GPIO_ev_status_switchirq_extract(word);
}
#define CSR_GPIO_EV_PENDING_ADDR (CSR_BASE + 0x300cL)
#define CSR_GPIO_EV_PENDING_SIZE 1
static inline uint32_t GPIO_ev_pending_read(void) {
	return csr_read_simple(CSR_BASE + 0x300cL);
}
static inline void GPIO_ev_pending_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x300cL);
}
#define CSR_GPIO_EV_PENDING_SWITCHIRQ_OFFSET 0
#define CSR_GPIO_EV_PENDING_SWITCHIRQ_SIZE 1
static inline uint32_t GPIO_ev_pending_switchirq_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t GPIO_ev_pending_switchirq_read(void) {
	uint32_t word = GPIO_ev_pending_read();
	return GPIO_ev_pending_switchirq_extract(word);
}
static inline uint32_t GPIO_ev_pending_switchirq_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void GPIO_ev_pending_switchirq_write(uint32_t plain_value) {
	uint32_t oldword = GPIO_ev_pending_read();
	uint32_t newword = GPIO_ev_pending_switchirq_replace(oldword, plain_value);
	GPIO_ev_pending_write(newword);
}
#define CSR_GPIO_EV_ENABLE_ADDR (CSR_BASE + 0x3010L)
#define CSR_GPIO_EV_ENABLE_SIZE 1
static inline uint32_t GPIO_ev_enable_read(void) {
	return csr_read_simple(CSR_BASE + 0x3010L);
}
static inline void GPIO_ev_enable_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x3010L);
}
#define CSR_GPIO_EV_ENABLE_SWITCHIRQ_OFFSET 0
#define CSR_GPIO_EV_ENABLE_SWITCHIRQ_SIZE 1
static inline uint32_t GPIO_ev_enable_switchirq_extract(uint32_t oldword) {
	uint32_t mask = ((1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t GPIO_ev_enable_switchirq_read(void) {
	uint32_t word = GPIO_ev_enable_read();
	return GPIO_ev_enable_switchirq_extract(word);
}
static inline uint32_t GPIO_ev_enable_switchirq_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void GPIO_ev_enable_switchirq_write(uint32_t plain_value) {
	uint32_t oldword = GPIO_ev_enable_read();
	uint32_t newword = GPIO_ev_enable_switchirq_replace(oldword, plain_value);
	GPIO_ev_enable_write(newword);
}
