//--------------------------------------------------------------------------------
// Auto-generated by Migen (7014bdc) & LiteX (9113c1a2) on 2021-09-08 22:39:44
//--------------------------------------------------------------------------------
module top(
...
reg main_soccontroller_reset_storage = 1'd0;
reg main_soccontroller_reset_re = 1'd0;
reg [31:0] main_soccontroller_scratch_storage = 32'd305419896;
reg main_soccontroller_scratch_re = 1'd0;
wire [31:0] main_soccontroller_bus_errors_status;
wire main_soccontroller_bus_errors_we;
reg main_soccontroller_bus_errors_re = 1'd0;
wire main_soccontroller_reset;
wire main_soccontroller_bus_error;
reg [31:0] main_soccontroller_bus_errors = 32'd0;
wire main_cpu_reset;
...
wire main_irq;
wire main_switchIRQ_status;
reg main_switchIRQ_pending = 1'd0;
wire main_switchIRQ_trigger;
reg main_switchIRQ_clear = 1'd0;
reg main_switchIRQ_trigger_d = 1'd0;
wire main_CLK;
wire main_RST;
wire [3:0] main_SW;
wire [3:0] main_LED;
wire main_IRQ;
reg [3:0] main_LED_REG_storage = 4'd0;
reg main_LED_REG_re = 1'd0;
wire [3:0] main_SW_REG_status;
wire main_SW_REG_we;
reg main_SW_REG_re = 1'd0;
wire [3:0] main_SW_REG_WIRE;
...
assign main_cpu_reset = main_soccontroller_reset;
assign main_CLK = sys_clk;
assign main_RST = sys_rst;
assign main_SW = {user_sw3, user_sw2, user_sw1, user_sw0};
assign {user_led3, user_led2, user_led1, user_led0} = main_LED;
assign main_soccontroller_bus_error = builder_error;
always @(*) begin
	main_cpu_interrupt <= 32'd0;
	main_cpu_interrupt[7] <= main_irq;
	main_cpu_interrupt[1] <= main_timer_irq;
	main_cpu_interrupt[0] <= main_uart_irq;
end
assign main_soccontroller_reset = main_soccontroller_reset_re;
assign main_soccontroller_bus_errors_status = main_soccontroller_bus_errors;
assign main_adr = main_ram_bus_adr[12:0];
...
assign app1_clk = main_clkout_buf1;
assign main_SW_REG_status = main_SW_REG_WIRE;
assign main_switchIRQ_trigger = (main_IRQ == 1'd1);
assign builder_switchIRQ0 = main_switchIRQ_status;
assign builder_switchIRQ1 = main_switchIRQ_pending;
always @(*) begin
	main_switchIRQ_clear <= 1'd0;
	if ((builder_pending_re & builder_pending_r)) begin
		main_switchIRQ_clear <= 1'd1;
	end
end
assign main_irq = (builder_pending_status & builder_enable_storage);
assign main_switchIRQ_status = main_switchIRQ_trigger;
always @(*) begin
...
assign main_cpu_ibus_dat_r = builder_shared_dat_r;
assign main_cpu_dbus_dat_r = builder_shared_dat_r;
assign main_cpu_ibus_ack = (builder_shared_ack & (builder_grant == 1'd0));
assign main_cpu_dbus_ack = (builder_shared_ack & (builder_grant == 1'd1));
assign main_cpu_ibus_err = (builder_shared_err & (builder_grant == 1'd0));
assign main_cpu_dbus_err = (builder_shared_err & (builder_grant == 1'd1));
assign builder_request = {main_cpu_dbus_cyc, main_cpu_ibus_cyc};
always @(*) begin
...
assign builder_shared_err = (((main_ram_bus_err | main_interface0_ram_bus_err) | main_interface1_ram_bus_err) | builder_basesoc_wishbone_err);
assign builder_wait = ((builder_shared_stb & builder_shared_cyc) & (~builder_shared_ack));
always @(*) begin
	builder_shared_dat_r <= 32'd0;
	builder_shared_ack <= 1'd0;
	builder_error <= 1'd0;
	builder_shared_ack <= (((main_ram_bus_ack | main_interface0_ram_bus_ack) | main_interface1_ram_bus_ack) | builder_basesoc_wishbone_ack);
	builder_shared_dat_r <= (((({32{builder_slave_sel_r[0]}} & main_ram_bus_dat_r) | ({32{builder_slave_sel_r[1]}} & main_interface0_ram_bus_dat_r)) | ({32{builder_slave_sel_r[2]}} & main_interface1_ram_bus_dat_r)) | ({32{builder_slave_sel_r[3]}} & builder_basesoc_wishbone_dat_r));
...
assign builder_csr_bankarray_csrbank0_LED_REG0_w = main_LED_REG_storage[3:0];
assign builder_csr_bankarray_csrbank0_SW_REG_w = main_SW_REG_status[3:0];
assign main_SW_REG_we = builder_csr_bankarray_csrbank0_SW_REG_we;
...
assign builder_csr_bankarray_csrbank1_reset0_w = main_soccontroller_reset_storage;
assign builder_csr_bankarray_csrbank1_scratch0_w = main_soccontroller_scratch_storage[31:0];
assign builder_csr_bankarray_csrbank1_bus_errors_w = main_soccontroller_bus_errors_status[31:0];
assign main_soccontroller_bus_errors_we = builder_csr_bankarray_csrbank1_bus_errors_we;
...
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed0 <= main_cpu_ibus_adr;
		end
		default: begin
			builder_array_muxed0 <= main_cpu_dbus_adr;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed1 <= main_cpu_ibus_dat_w;
		end
		default: begin
			builder_array_muxed1 <= main_cpu_dbus_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed2 <= main_cpu_ibus_sel;
		end
		default: begin
			builder_array_muxed2 <= main_cpu_dbus_sel;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed3 <= main_cpu_ibus_cyc;
		end
		default: begin
			builder_array_muxed3 <= main_cpu_dbus_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed4 <= main_cpu_ibus_stb;
		end
		default: begin
			builder_array_muxed4 <= main_cpu_dbus_stb;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed5 <= main_cpu_ibus_we;
		end
		default: begin
			builder_array_muxed5 <= main_cpu_dbus_we;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed6 <= main_cpu_ibus_cti;
		end
		default: begin
			builder_array_muxed6 <= main_cpu_dbus_cti;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		1'd0: begin
			builder_array_muxed7 <= main_cpu_ibus_bte;
		end
		default: begin
			builder_array_muxed7 <= main_cpu_dbus_bte;
		end
	endcase
end
...
always @(posedge sys_clk) begin
	if ((main_soccontroller_bus_errors != 32'd4294967295)) begin
		if (main_soccontroller_bus_error) begin
			main_soccontroller_bus_errors <= (main_soccontroller_bus_errors + 1'd1);
		end
	end
	...
	if (((main_interface0_ram_bus_cyc & main_interface0_ram_bus_stb) & (~main_interface0_ram_bus_ack))) begin
		main_interface0_ram_bus_ack <= 1'd1;
	end
	main_interface1_ram_bus_ack <= 1'd0;
	if (((main_interface1_ram_bus_cyc & main_interface1_ram_bus_stb) & (~main_interface1_ram_bus_ack))) begin
		main_interface1_ram_bus_ack <= 1'd1;
	end
	{main_tx_tick, main_tx_phase} <= 22'd3534144;
	if (main_tx_enable) begin
		{main_tx_tick, main_tx_phase} <= (main_tx_phase + 22'd3534144);
	end
	...
	if (main_rx_enable) begin
		{main_rx_tick, main_rx_phase} <= (main_rx_phase + 22'd3534144);
	end
	...
	if (main_switchIRQ_clear) begin
		main_switchIRQ_pending <= 1'd0;
	end
	main_switchIRQ_trigger_d <= main_switchIRQ_trigger;
	if ((main_switchIRQ_trigger & (~main_switchIRQ_trigger_d))) begin
		main_switchIRQ_pending <= 1'd1;
	end
	...
	if (builder_csr_bankarray_csrbank0_LED_REG0_re) begin
		main_LED_REG_storage[3:0] <= builder_csr_bankarray_csrbank0_LED_REG0_r;
	end
	main_LED_REG_re <= builder_csr_bankarray_csrbank0_LED_REG0_re;
	main_SW_REG_re <= builder_csr_bankarray_csrbank0_SW_REG_re;
	...
	if (builder_csr_bankarray_csrbank1_reset0_re) begin
		main_soccontroller_reset_storage <= builder_csr_bankarray_csrbank1_reset0_r;
	end
	main_soccontroller_reset_re <= builder_csr_bankarray_csrbank1_reset0_re;
	if (builder_csr_bankarray_csrbank1_scratch0_re) begin
		main_soccontroller_scratch_storage[31:0] <= builder_csr_bankarray_csrbank1_scratch0_r;
	end
	main_soccontroller_scratch_re <= builder_csr_bankarray_csrbank1_scratch0_re;
	main_soccontroller_bus_errors_re <= builder_csr_bankarray_csrbank1_bus_errors_re;
	...
	if (sys_rst) begin
		main_soccontroller_reset_storage <= 1'd0;
		main_soccontroller_reset_re <= 1'd0;
		main_soccontroller_scratch_storage <= 32'd305419896;
		main_soccontroller_scratch_re <= 1'd0;
		main_soccontroller_bus_errors_re <= 1'd0;
		main_soccontroller_bus_errors <= 32'd0;
		main_ram_bus_ack <= 1'd0;
		main_interface0_ram_bus_ack <= 1'd0;
		main_interface1_ram_bus_ack <= 1'd0;
		serial_tx <= 1'd0;
		...
		main_switchIRQ_pending <= 1'd0;
		main_switchIRQ_trigger_d <= 1'd0;
		main_LED_REG_storage <= 4'd0;
		main_LED_REG_re <= 1'd0;
		main_SW_REG_re <= 1'd0;
...
always @(posedge sys_clk) begin
	if (main_sram0_we[0])
		mem_1[main_sram0_adr][7:0] <= main_sram0_dat_w[7:0];
	if (main_sram0_we[1])
		mem_1[main_sram0_adr][15:8] <= main_sram0_dat_w[15:8];
	if (main_sram0_we[2])
		mem_1[main_sram0_adr][23:16] <= main_sram0_dat_w[23:16];
	if (main_sram0_we[3])
		mem_1[main_sram0_adr][31:24] <= main_sram0_dat_w[31:24];
	memadr <= main_sram0_adr;
end

assign main_sram0_dat_r = mem_1[memadr];
...
always @(posedge sys_clk) begin
	if (main_sram1_we[0])
		mem_2[main_sram1_adr][7:0] <= main_sram1_dat_w[7:0];
	if (main_sram1_we[1])
		mem_2[main_sram1_adr][15:8] <= main_sram1_dat_w[15:8];
	if (main_sram1_we[2])
		mem_2[main_sram1_adr][23:16] <= main_sram1_dat_w[23:16];
	if (main_sram1_we[3])
		mem_2[main_sram1_adr][31:24] <= main_sram1_dat_w[31:24];
	memadr_1 <= main_sram1_adr;
end

assign main_sram1_dat_r = mem_2[memadr_1];
...
gpio gpio(
	.clk(main_CLK),
	.led_reg(main_LED_REG_storage),
	.rst(main_RST),
	.sw(main_SW),
	.irq(main_IRQ),
	.led(main_LED),
	.sw_reg(main_SW_REG_WIRE)
);
