//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5bc262) & LiteX (7f8e2e39) on 2021-09-17 19:35:56
//--------------------------------------------------------------------------------
module main(
...
wire [11:0] main_basesoc_sram1_adr;
...
always @(*) begin
	...
	main_basesoc_interrupt[7] <= main_irq;
...
assign main_basesoc_sram1_adr = main_basesoc_interface1_ram_bus_adr[11:0];
...
assign app1_clk = main_crg_clkout_buf1;
...
always @(posedge sys_clk) begin
	...
	{main_basesoc_tx_tick, main_basesoc_tx_phase} <= 22'd3534144;
	if (main_basesoc_tx_enable) begin
		{main_basesoc_tx_tick, main_basesoc_tx_phase} <= (main_basesoc_tx_phase + 22'd3534144);
	end
	...
	if (main_basesoc_rx_enable) begin
		{main_basesoc_rx_tick, main_basesoc_rx_phase} <= (main_basesoc_rx_phase + 22'd3534144);
	end
...
always @(posedge sys_clk) begin
	...
	memadr <= main_basesoc_sram0_adr;
end

assign main_basesoc_sram0_dat_r = mem_1[memadr];
...
always @(posedge sys_clk) begin
	...
	memadr_1 <= main_basesoc_sram1_adr;
end

assign main_basesoc_sram1_dat_r = mem_2[memadr_1];
