...
#define CSR_GPIO_LED_REG_ADDR (CSR_BASE + 0x0L)
...
#define CSR_GPIO_SW_REG_ADDR (CSR_BASE + 0x4L)
#define CSR_GPIO_SW_REG_SIZE 1
static inline uint32_t GPIO_SW_REG_read(void) {
	return csr_read_simple(CSR_BASE + 0x4L);
}
#define CSR_GPIO_EV_STATUS_ADDR (CSR_BASE + 0x8L)
...
#define CSR_GPIO_EV_PENDING_ADDR (CSR_BASE + 0xcL)
...
#define CSR_GPIO_EV_ENABLE_ADDR (CSR_BASE + 0x10L)
